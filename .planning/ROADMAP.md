...
- [x] **Phase 3.4: Activity List Row Height & Pagination Styling** - INSERTED - Reduce row height to 19px, style pagination footer to match grid header
...
Plans:
- [x] 03.4-01-PLAN.md -- Compact row height (19px) via CSS custom properties and pagination footer background matching header
